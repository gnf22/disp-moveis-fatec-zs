...
public class ConsultaUsuarioParametro extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Cursor cursor = Login.usuCont.carregarUsuariosPorNome(nome);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ConsultaUsuarioParametro.this, AlterarUsuario.class);
